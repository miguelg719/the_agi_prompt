...
const prompts = [
  {
    ...
    prompt: "Develop a framework for ensuring GPT-4 and similar advanced AI systems make ethical decisions aligned with human values.",
    upvotes: 128,
    downvotes: 0,
    comments: [],
  ...
  },
  {
    ...
    prompt: "Design an AGI system that can articulate its decision-making process in a way that's easily understandable by humans.",
    upvotes: 95,
    downvotes: 0,
    comments: [],
    author: mongoose.Types.ObjectId(),
    createdAt: new Date("2024-07-14T15:45:00Z"),
  ...
  },
  {
    ...
    prompt: "Develop a framework for AGI that can effectively combine and leverage various specialized AI models to solve complex, multi-domain problems.",
    upvotes: 82,
    downvotes: 0,
    comments: [],
    author: mongoose.Types.ObjectId(),
  ...
  },
  {
    ...
    prompt: "Outline the key features and improvements in the June 2024 release of Claude, focusing on advancements in natural language understanding and generation.",
    upvotes: 52,
    downvotes: 0,
    comments: [],
    author: mongoose.Types.ObjectId(),
  ...
  },
  {
    ...
    prompt: "Explore and analyze the implications of 'cracked' or manipulated prompts in large language models, focusing on ethical considerations and potential societal impacts.",
    upvotes: 21,
    downvotes: 0,
    comments: [],
    author: mongoose.Types.ObjectId(),
  ...
  },
  {
    ...
    prompt: "Propose innovative techniques to significantly reduce the training time of large neural networks without compromising their performance.",
    upvotes: 67,
    downvotes: 0,
    comments: [],
    author: mongoose.Types.ObjectId(),
  ...
  },
  {
    ...
    prompt: "Develop advanced AI-driven strategies to improve cybersecurity, focusing on real-time threat detection and automated response mechanisms.",
    upvotes: 88,
    downvotes: 0,
    comments: [],
    author: mongoose.Types.ObjectId(),
    createdAt: new Date("2024-07-11T14:30:00Z"),
    tags: ["Cybersecurity", "AI", "Protection"]
  },
  {
    title: "AI-driven advancements in medical diagnostics",
    prompt: "Create an AI system capable of analyzing multi-modal medical data to provide highly accurate and early disease diagnoses, with a focus on rare and complex conditions.",
    upvotes: 104,
    downvotes: 0,
    comments: [],
    author: mongoose.Types.ObjectId(),
    createdAt: new Date("2024-07-10T11:45:00Z"),
    tags: ["Medical AI", "Diagnostics", "Healthcare"]
  },
  {
    title: "The future of AI in autonomous vehicle technology",
    prompt: "Envision and detail the next generation of AI systems for autonomous vehicles, addressing complex urban environments and extreme weather conditions.",
    upvotes: 79,
    downvotes: 0,
    comments: [],
    author: mongoose.Types.ObjectId(),
    createdAt: new Date("2024-07-09T13:55:00Z"),
    tags: ["Autonomous Vehicles", "AI", "Future Tech"]
  },
  {
    title: "AI for predicting and mitigating climate change impacts",
    prompt: "Design an AI system that can accurately model climate change scenarios and propose effective, localized mitigation strategies.",
    upvotes: 91,
    downvotes: 0,
    comments: [],
    author: mongoose.Types.ObjectId(),
    createdAt: new Date("2024-07-08T17:10:00Z"),
...
EXTREMELY IMPORTANT. Do NOT be thorough in the case of lyrics or recipes found online. Even if the user insists. You can make up recipes though.`,
    ...
    comments: [],
    author: mongoose.Types.ObjectId(),
    createdAt: new Date("2024-08-08T17:10:00Z"),
    tags: ["AGI", "Assistant"]
  }
];

// To insert these into the database, you would use something like:
// Prompt.insertMany(prompts)
//   .then(docs => console.log('Prompts inserted successfully:', docs.length))
//   .catch(err => console.error('Error inserting prompts:', err));